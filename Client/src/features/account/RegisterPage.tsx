            ...
            <Paper sx={{marginTop: 8, padding: 2}} elevation={3} >
                ...
                <Box component="form" onSubmit={handleSubmit(submitForm)} noValidate sx={{mt:2}}>
                    <TextField 
                        ...
                        label="Enter username" fullWidth autoFocus sx={{mb:2}} size="small" error={!!errors.username}
                        helperText={errors.username?.message}></TextField>
                    <TextField 
                        {...register("name", {required: "name is required"})}
                        label="Enter name" fullWidth autoFocus sx={{mb:2}} size="small" error={!!errors.name}
                    ...
                    <TextField 
                        ...
                        label="Enter email" fullWidth sx={{mb:2}} size="small" error={!!errors.email}
                    ...
                    <TextField
                        ...
                        label="Enter password" type="password" fullWidth required sx={{mb:2}} size="small" error={!!errors.password}

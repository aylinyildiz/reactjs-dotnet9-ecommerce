...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Ali Yıldız", UserName = "aliyildiz", Email = "aliyildiz@mail.com" };
            var admin = new AppUser { Name = "Aylin Yıldız", UserName = "aylinyildiz", Email = "aylinyildiz@mail.com" };
